        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('entities',$socSeg->id)}}">{{$socSeg->name}}</a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{--<form action="{{ route('entities.update',$socSeg->id) }}" method="post" id="editSG" name="editSG">--}}
                        {{method_field('PUT')}}
                        {{csrf_field()}}
                        <div class="form-body">
